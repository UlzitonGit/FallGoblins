...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Punch()
        {
            if(canPunch == true && Input.GetKey(KeyCode.Mouse0))
            {
        ...
        private void JumpAndGravity()
        {
            ...
            if (_verticalVelocity < _terminalVelocity && inWind == false)
            {
                _verticalVelocity += Gravity * Time.deltaTime;
            }
            if (_verticalVelocity < _terminalVelocity && inWind == true)
            {
                _verticalVelocity -= Gravity * Time.deltaTime;
            }
        }
